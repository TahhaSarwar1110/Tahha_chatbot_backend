...
def detect_intent(user_input):
    intents = {
        "add employee": [
            "add a new employee to my team?", "officially add", "setup a profile","register a new staff member", "correct way to add him","correct way to add her",
            ...
            "add an employee", "bring a new employee", "correct way to add an employee", "new employee", "register a new staff member", "input new team members", "input new hire"
