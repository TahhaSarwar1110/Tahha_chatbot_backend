...
The AI should understand the context. It should understand the diiference between bulk updating emails in the staff list and bulk adding employees and answer as written in the document.
